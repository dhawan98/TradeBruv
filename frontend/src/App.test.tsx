    ...
    const payloads: Record<string, unknown> = {
      ...
      '/api/daily-decision/latest': {
        ...
        signal_table: [
          {
            ...
            actionability: 'Breakout Actionable Today',
            risk: 'Low',
        ...
        workspace: {
          ...
          data_issues: [],
          source_aware_top: {
            overall_top_setup: { ticker: 'NVDA', source_groups: ['Tracked', 'Broad'], actionability_label: 'Breakout Actionable Today', actionability_score: 84 },
            best_tracked_setup: { ticker: 'NVDA', actionability_label: 'Breakout Actionable Today', actionability_score: 84 },
            best_broad_setup: null,
          },
